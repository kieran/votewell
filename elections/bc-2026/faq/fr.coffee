  ...
  render: ->
    <section key='faq' className='faq'>
      ...
      <Qna question="...Et si je veux que le parti Conservateur remporte l’élection?">
        <p>Vous devriez donner votre voix au parti Conservateur! Cet outil s’adresse aux électeurs qui souhaitent que la Gauche gagne, alors il ne vous dira pas de faire autrement.</p>
