  ...
  faq: ->
    if @isEnglish()
      ...
      <section key='faq' className='faq'>
        ...
        <Qna question="Qu’est-ce c’est un vote utile?">
        ...
        <Qna question="...Et si je veux que le parti Conservateur remporte l’élection?">
          <p>Vous devriez donner votre voix au parti Conservateur! Puisque il n’y a pas d’émiettement des voix droites, cet outil n’est pas nécessaire.</p>
          <p>Merci d’avoir participer à notre devoir civique en commun.</p>
        </Qna>

        <Qna question="Qui êtes-vous?">
          <p>Je m’appelle <a href="https://kieran.ca">Kieran Huggins</a> et je viens de Toronto, Canada.</p>
          <p>Bien que j’aie des tendences gauchistes, je ne suis pas affilié à aucun parti politique.</p>
        </Qna>
      </section>
